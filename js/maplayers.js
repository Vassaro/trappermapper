...
function renderProperty(property, lng) {
...
function getSources(sourceList, lng) {
                ...
                L.geoJSON(data, {
                    onEachFeature: function (feature, layer) {
                        ...
                        if (!feature.properties.skip) { // för att dölja vissa stigar
                            layer.bindPopup("<b>" + renderProperty(feature.properties.title, lng) || + "</b><br>" + renderProperty(feature.properties.desc, lng));
...
const OPTIONS = {
    closedSymbol: '<span class="iconify" data-icon="mdi-chevron-right"></span>',
    openedSymbol: '<span class="iconify" data-icon="mdi-chevron-down"></span>',
    selectorBack: false,
    namedToggle: false,
